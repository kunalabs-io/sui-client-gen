...
export function bitwiseNot(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::u64::bitwise_not`,
...
export function max(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::u64::max`,
    arguments: [
      pure(tx, args.x, `u64`),
      pure(tx, args.y, `u64`),
    ],
...
export function min(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::u64::min`,
    arguments: [
      pure(tx, args.x, `u64`),
      pure(tx, args.y, `u64`),
    ],
...
export function diff(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::u64::diff`,
    arguments: [
      pure(tx, args.x, `u64`),
      pure(tx, args.y, `u64`),
    ],
...
export function divideAndRoundUp(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::u64::divide_and_round_up`,
    arguments: [
      pure(tx, args.x, `u64`),
      pure(tx, args.y, `u64`),
    ],
...
export function pow(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::u64::pow`,
    arguments: [
...
export function sqrt(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::u64::sqrt`,
    arguments: [pure(tx, x, `u64`)],
  })
}
...
export function tryAsU8(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::u64::try_as_u8`,
    arguments: [pure(tx, x, `u64`)],
  })
}
...
export function tryAsU16(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::u64::try_as_u16`,
    arguments: [pure(tx, x, `u64`)],
  })
}
...
export function tryAsU32(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::u64::try_as_u32`,
    arguments: [pure(tx, x, `u64`)],
  })
}
...
export function toString(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::u64::to_string`,
    arguments: [pure(tx, x, `u64`)],
  })
}
