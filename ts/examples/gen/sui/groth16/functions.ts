...
export interface PrepareVerifyingKeyArgs {
  curve: ObjectArg
  verifyingKey: Array<number | TransactionArgument>
}
...
export interface PvkFromBytesArgs {
  vkGammaAbcG1Bytes: Array<number | TransactionArgument>
  alphaG1BetaG2Bytes: Array<number | TransactionArgument>
  gammaG2NegPcBytes: Array<number | TransactionArgument>
  deltaG2NegPcBytes: Array<number | TransactionArgument>
}
...
export interface VerifyGroth16ProofInternalArgs {
  ...
  gammaG2NegPcBytes: Array<number | TransactionArgument>
  deltaG2NegPcBytes: Array<number | TransactionArgument>
  publicProofInputs: Array<number | TransactionArgument>
  proofPoints: Array<number | TransactionArgument>
}
