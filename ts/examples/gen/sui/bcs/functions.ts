...
export function toBytes(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::to_bytes`,
...
export function new_(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::new`,
...
export function intoRemainderBytes(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::into_remainder_bytes`,
...
export function peelAddress(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_address`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelBool(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_bool`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelU8(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_u8`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelU16(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_u16`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelU32(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_u32`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelU64(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_u64`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelU128(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_u128`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelU256(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_u256`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelVecLength(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_vec_length`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelVecAddress(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_vec_address`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelVecBool(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_vec_bool`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelVecU8(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_vec_u8`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelVecVecU8(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_vec_vec_u8`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelVecU16(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_vec_u16`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelVecU32(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_vec_u32`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelVecU64(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_vec_u64`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelVecU128(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_vec_u128`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelVecU256(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_vec_u256`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelEnumTag(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_enum_tag`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelOptionAddress(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_option_address`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelOptionBool(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_option_bool`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelOptionU8(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_option_u8`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelOptionU16(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_option_u16`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelOptionU32(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_option_u32`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelOptionU64(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_option_u64`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelOptionU128(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_option_u128`,
    arguments: [obj(tx, bcs)],
  })
}
...
export function peelOptionU256(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bcs::peel_option_u256`,
    arguments: [obj(tx, bcs)],
  })
}
