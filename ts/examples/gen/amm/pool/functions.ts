...
export function values(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::values`,
...
export function fees(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::fees`,
    typeArguments: typeArgs,
    arguments: [obj(tx, pool)],
  })
}
...
export function adminFeeValue(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::admin_fee_value`,
    typeArguments: typeArgs,
    arguments: [obj(tx, pool)],
  })
}
...
export function newRegistry(tx: Transaction, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::new_registry`,
    arguments: [],
  })
}
...
export function cmpTypeNames(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::cmp_type_names`,
    arguments: [
      obj(tx, args.a),
      obj(tx, args.b),
    ],
...
export function registryAdd(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::registry_add`,
    typeArguments: typeArgs,
...
export function muldiv(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::muldiv`,
    arguments: [
      pure(tx, args.a, `u64`),
      pure(tx, args.b, `u64`),
      pure(tx, args.c, `u64`),
...
export function ceilMuldiv(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::ceil_muldiv`,
    arguments: [
      pure(tx, args.a, `u64`),
      pure(tx, args.b, `u64`),
      pure(tx, args.c, `u64`),
...
/** Calculates sqrt(a * b). */
export function mulsqrt(
  tx: Transaction,
  args: MulsqrtArgs,
  options?: { env?: EnvConfig },
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::mulsqrt`,
    arguments: [
      pure(tx, args.a, `u64`),
      pure(tx, args.b, `u64`),
    ],
...
export function muldivU128(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::muldiv_u128`,
    arguments: [
      pure(tx, args.a, `u128`),
      pure(tx, args.b, `u128`),
      pure(tx, args.c, `u128`),
...
export function init(tx: Transaction, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::init`,
    arguments: [],
  })
}
...
export function create(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::create`,
    typeArguments: typeArgs,
    arguments: [
...
export function deposit(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::deposit`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.pool),
      obj(tx, args.inputA),
...
export function withdraw(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::withdraw`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.pool),
      obj(tx, args.lpIn),
...
export function calcSwapResult(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::calc_swap_result`,
    arguments: [
...
export function swapA(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::swap_a`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.pool),
      obj(tx, args.input),
...
export function swapB(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::swap_b`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.pool),
      obj(tx, args.input),
...
export function adminWithdrawFees(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::admin_withdraw_fees`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.pool),
...
export function adminSetFees(
  tx: Transaction,
  typeArgs: [string, string],
  args: AdminSetFeesArgs,
  options?: { env?: EnvConfig },
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('amm', options?.env)}::pool::admin_set_fees`,
    typeArguments: typeArgs,
    arguments: [
      obj(tx, args.pool),
      obj(tx, args.adminCap),
