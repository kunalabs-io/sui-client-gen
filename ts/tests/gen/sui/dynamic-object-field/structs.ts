...
export class Wrapper<Name extends TypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V29}::dynamic_object_field::Wrapper<${ToTypeStr<Name>}>`
  ...
  private constructor(typeArgs: [ToTypeStr<Name>], fields: WrapperFields<Name>) {
    this.$fullTypeName = composeSuiType(
      Wrapper.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V29}::dynamic_object_field::Wrapper<${ToTypeStr<Name>}>`
  ...
  static reified<Name extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Wrapper.$typeName,
        ...[extractType(Name)]
      ) as `${typeof PKG_V29}::dynamic_object_field::Wrapper<${ToTypeStr<ToTypeArgument<Name>>}>`,
