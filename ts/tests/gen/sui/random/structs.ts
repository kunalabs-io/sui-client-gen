...
export function isRandom(type: string): boolean {
  ...
  return type === `${PKG_V32}::random::Random`
}
...
export class Random implements StructClass {
  ...
  static readonly $typeName = `${PKG_V32}::random::Random`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = Random.$typeName
  readonly $fullTypeName: `${typeof PKG_V32}::random::Random`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: RandomFields) {
    this.$fullTypeName = composeSuiType(
      Random.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V32}::random::Random`
  ...
  static reified(): RandomReified {
    return {
      ...
      fullTypeName: composeSuiType(Random.$typeName, ...[]) as `${typeof PKG_V32}::random::Random`,
      typeArgs: [] as [],
...
export function isRandomInner(type: string): boolean {
  type = compressSuiType(type)
  return type === `${PKG_V32}::random::RandomInner`
}
...
export class RandomInner implements StructClass {
  ...
  static readonly $typeName = `${PKG_V32}::random::RandomInner`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = RandomInner.$typeName
  readonly $fullTypeName: `${typeof PKG_V32}::random::RandomInner`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: RandomInnerFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V32}::random::RandomInner`
    this.$typeArgs = typeArgs
...
export function isRandomGenerator(type: string): boolean {
  type = compressSuiType(type)
  return type === `${PKG_V32}::random::RandomGenerator`
}
...
export class RandomGenerator implements StructClass {
  ...
  static readonly $typeName = `${PKG_V32}::random::RandomGenerator`
  static readonly $numTypeParams = 0
  static readonly $isPhantom = [] as const

  readonly $typeName = RandomGenerator.$typeName
  readonly $fullTypeName: `${typeof PKG_V32}::random::RandomGenerator`
  readonly $typeArgs: []
  ...
  private constructor(typeArgs: [], fields: RandomGeneratorFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V32}::random::RandomGenerator`
    this.$typeArgs = typeArgs
