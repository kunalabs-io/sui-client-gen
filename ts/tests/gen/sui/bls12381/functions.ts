...
export function bls12381MinSigVerify(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::bls12381_min_sig_verify`,
    arguments: [
...
export function bls12381MinPkVerify(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::bls12381_min_pk_verify`,
    arguments: [
      pure(tx, args.signature, `vector<u8>`),
      pure(tx, args.publicKey, `vector<u8>`),
      pure(tx, args.msg, `vector<u8>`),
...
export function scalarFromBytes(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::scalar_from_bytes`,
...
export function scalarFromU64(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::scalar_from_u64`,
...
export function scalarZero(tx: Transaction, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::scalar_zero`,
    arguments: [],
  })
}
...
export function scalarOne(tx: Transaction, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::scalar_one`,
    arguments: [],
  })
}
...
export function scalarAdd(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::scalar_add`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function scalarSub(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::scalar_sub`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function scalarMul(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::scalar_mul`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function scalarDiv(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::scalar_div`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function scalarNeg(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::scalar_neg`,
    arguments: [obj(tx, e)],
  })
}
...
export function scalarInv(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::scalar_inv`,
    arguments: [obj(tx, e)],
  })
}
...
export function g1FromBytes(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g1_from_bytes`,
    arguments: [pure(tx, bytes, `vector<u8>`)],
  })
}

export function g1Identity(tx: Transaction, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g1_identity`,
    arguments: [],
  })
}

export function g1Generator(tx: Transaction, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g1_generator`,
    arguments: [],
  })
}
...
export function g1Add(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g1_add`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function g1Sub(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g1_sub`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function g1Mul(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g1_mul`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function g1Div(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g1_div`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function g1Neg(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g1_neg`,
    arguments: [obj(tx, e)],
  })
}
...
export function hashToG1(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::hash_to_g1`,
...
export function g1MultiScalarMultiplication(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g1_multi_scalar_multiplication`,
    arguments: [
...
export function g1ToUncompressedG1(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g1_to_uncompressed_g1`,
    arguments: [obj(tx, e)],
  })
}
...
export function g2FromBytes(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g2_from_bytes`,
    arguments: [pure(tx, bytes, `vector<u8>`)],
  })
}

export function g2Identity(tx: Transaction, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g2_identity`,
    arguments: [],
  })
}

export function g2Generator(tx: Transaction, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g2_generator`,
    arguments: [],
  })
}
...
export function g2Add(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g2_add`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function g2Sub(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g2_sub`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function g2Mul(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g2_mul`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function g2Div(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g2_div`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function g2Neg(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g2_neg`,
    arguments: [obj(tx, e)],
  })
}
...
export function hashToG2(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::hash_to_g2`,
    arguments: [pure(tx, m, `vector<u8>`)],
  })
}
...
export function g2MultiScalarMultiplication(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::g2_multi_scalar_multiplication`,
    arguments: [
      vector(tx, `${Element.$typeName}<${Scalar.$typeName}>`, args.scalars),
...
export function gtIdentity(tx: Transaction, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::gt_identity`,
    arguments: [],
  })
}

export function gtGenerator(tx: Transaction, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::gt_generator`,
    arguments: [],
  })
}
...
export function gtAdd(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::gt_add`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function gtSub(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::gt_sub`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function gtMul(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::gt_mul`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function gtDiv(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::gt_div`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function gtNeg(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::gt_neg`,
    arguments: [obj(tx, e)],
  })
}
...
export function pairing(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::pairing`,
    arguments: [
      obj(tx, args.e1),
      obj(tx, args.e2),
    ],
...
export function uncompressedG1ToG1(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::uncompressed_g1_to_g1`,
    arguments: [obj(tx, e)],
  })
}
...
export function uncompressedG1Sum(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('sui', options?.env)}::bls12381::uncompressed_g1_sum`,
