...
export function asString(tx: Transaction, typeName: TransactionObjectInput) {
  return tx.moveCall({
...
export function addressString(tx: Transaction, typeName: TransactionObjectInput) {
  return tx.moveCall({
...
export function moduleString(tx: Transaction, typeName: TransactionObjectInput) {
  return tx.moveCall({
