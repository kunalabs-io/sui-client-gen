...
export function fromQuotient(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::from_quotient`,
    arguments: [
...
export function fromInt(
  tx: Transaction,
  integer: number | TransactionArgument,
  options?: { env?: EnvConfig },
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::from_int`,
...
export function add(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::add`,
    arguments: [
      obj(tx, args.a),
      obj(tx, args.b),
    ],
...
export function sub(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::sub`,
    arguments: [
      obj(tx, args.a),
      obj(tx, args.b),
    ],
...
export function mul(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::mul`,
    arguments: [
      obj(tx, args.a),
      obj(tx, args.b),
    ],
...
export function div(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::div`,
    arguments: [
      obj(tx, args.a),
      obj(tx, args.b),
    ],
...
export function toInt(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::to_int`,
    arguments: [obj(tx, a)],
  })
}
...
export function intMul(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::int_mul`,
    arguments: [
...
export function intDiv(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::int_div`,
    arguments: [
      pure(tx, args.val, `u64`),
      obj(tx, args.divisor),
    ],
...
export function le(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::le`,
    arguments: [
      obj(tx, args.a),
      obj(tx, args.b),
    ],
...
export function lt(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::lt`,
    arguments: [
      obj(tx, args.a),
      obj(tx, args.b),
    ],
...
export function ge(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::ge`,
    arguments: [
      obj(tx, args.a),
      obj(tx, args.b),
    ],
...
export function gt(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::gt`,
    arguments: [
      obj(tx, args.a),
      obj(tx, args.b),
    ],
...
export function toRaw(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::to_raw`,
    arguments: [obj(tx, a)],
  })
}
...
export function fromRaw(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::uq32_32::from_raw`,
