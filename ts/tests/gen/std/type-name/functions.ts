 ...
 */
export function withDefiningIds(
  tx: Transaction,
  typeArg: string,
  options?: { env?: EnvConfig },
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::with_defining_ids`,
 ...
 */
export function withOriginalIds(
  tx: Transaction,
  typeArg: string,
  options?: { env?: EnvConfig },
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::with_original_ids`,
    typeArguments: [typeArg],
    arguments: [],
  })
}
...
export function definingId(
  tx: Transaction,
  typeArg: string,
  options?: { env?: EnvConfig },
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::defining_id`,
    typeArguments: [typeArg],
    arguments: [],
  })
}
...
export function originalId(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::original_id`,
    typeArguments: [typeArg],
    arguments: [],
  })
}
...
export function isPrimitive(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::is_primitive`,
...
export function asString(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::as_string`,
    arguments: [obj(tx, self)],
  })
}
...
export function addressString(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::address_string`,
    arguments: [obj(tx, self)],
  })
}
...
export function moduleString(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::module_string`,
    arguments: [obj(tx, self)],
  })
}
...
export function intoString(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::into_string`,
    arguments: [obj(tx, self)],
  })
}
...
export function get(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::get`,
    typeArguments: [typeArg],
    arguments: [],
  })
}
...
export function getWithOriginalIds(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::get_with_original_ids`,
    typeArguments: [typeArg],
    arguments: [],
  })
}
...
export function borrowString(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::borrow_string`,
    arguments: [obj(tx, self)],
  })
}
...
export function getAddress(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::get_address`,
    arguments: [obj(tx, self)],
  })
}
...
export function getModule(
  ...
  return tx.moveCall({
    target: `${getPublishedAt('std', options?.env)}::type_name::get_module`,
    arguments: [obj(tx, self)],
  })
}
