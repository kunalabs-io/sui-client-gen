...
export function length(txb: TransactionBlock, typeArgs: [Type, Type], objectTable: ObjectArg) {
  return txb.moveCall({
...
export function isEmpty(txb: TransactionBlock, typeArgs: [Type, Type], objectTable: ObjectArg) {
  return txb.moveCall({
