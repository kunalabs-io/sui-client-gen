...
export function purchaseCapKiosk(txb: TransactionBlock, typeArg: Type, purchaseCap: ObjectArg) {
  return txb.moveCall({
...
export function purchaseCapItem(txb: TransactionBlock, typeArg: Type, purchaseCap: ObjectArg) {
  return txb.moveCall({
...
export function purchaseCapMinPrice(txb: TransactionBlock, typeArg: Type, purchaseCap: ObjectArg) {
  return txb.moveCall({
