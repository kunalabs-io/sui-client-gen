...
impl FrameworkImportCtx {
    ...
    fn import(&self, module: &str, name: &str) -> kotlin::Import {
        kotlin::import(format!("{}/{}", self.framework_rel_path, module), name)
    }
}
...
fn gen_full_name_with_address<const HAS_SOURCE: SourceKind>(
    ...
    let pkg_import = kotlin::import("../index", format!("PKG_V{}", version.value()));

    // `${PKG_V1}::module::name`
    let mut toks = kotlin::Tokens::new();
    if open_quote {
        ...
        export function registerClasses(loader: $struct_class_loader) {
            $(ref toks {
                for module in pkg.modules() {
                    ...
                    let module_import = &kotlin::import(
...
pub fn gen_init_loader_ts(
    ...
    let struct_class_loader = &kotlin::import("./loader", "StructClassLoader");
...
fn gen_func_generics(count: usize) -> impl FormatInto<Kotlin> {
    quote! {
        $(if count > 0 {
            <$(for i in 0..count join(, ) => T$i)>
        })
    }
}
...
fn gen_type_args_param(
    count: usize,
    prefix: impl FormatInto<Kotlin>,
    suffix: impl FormatInto<Kotlin>,
) -> impl FormatInto<Kotlin> {
    quote! {
        $(match count {
            0 => (),
            1 => $(prefix)typeArg: String$suffix,
            _ => $(prefix)typeArgs: List<String>$suffix
        })
    }
}

enum QuoteItem {
    Interpolated(Tokens<Kotlin>),
    #[allow(dead_code)]
    Literal(String),
}
...
impl<'a, 'model, const HAS_SOURCE: SourceKind> FunctionsGen<'a, 'model, HAS_SOURCE> {
    ...
    fn param_type_to_field_type(&self, ty: &Type) -> kotlin::Tokens {
        let generic_arg = &kotlin::import("xyz.mcxross.ksui.model", "GenericArgument");
        let transaction_argument = &kotlin::import("xyz.mcxross.ksui.model", "TransactionArgument");
    ...
    pub fn gen_fun_args_if(&self, tokens: &mut Tokens<Kotlin>) -> Result<()> {
    ...
    pub fn gen_fun_binding(&mut self, tokens: &mut kotlin::Tokens) -> Result<()> {
        ...
        let published_at = &kotlin::import("xyz.mcxross.ksui", "PUBLISHED_AT");
        ...
        quote_in! { *tokens =>
            fun $(self.fun_name())(
                ...
                return builder.moveCall {
                    ...
                    typeArguments = when (type_arg_count) {
                                        1 -> listOf(typeArg)
                                        else -> typeArgs
                    }
                    arguments = listOf($(if param_field_names.len() == 1 {
...
impl<'a, 'model, const HAS_SOURCE: SourceKind> StructsGen<'a, 'model, HAS_SOURCE> {
    ...
    fn gen_full_name_with_address(&self, open_quote: bool, as_type: bool) -> kotlin::Tokens {
    ...
    fn gen_struct_class_field_type(
        ...
        ty: &Type,
        type_param_names: &[String],
        wrap_non_phantom_type_parameter: Option<kotlin::Tokens>,
        wrap_phantom_type_parameter: Option<kotlin::Tokens>,
    ) -> kotlin::Tokens {
    ...
    fn gen_struct_class_field_type_inner(
        ...
        let to_phantom = &self.framework.import("reified", "ToTypeStr");
    ...
    fn gen_struct_bcs_def_field_value(
        ...
        let bcs = &kotlin::import("@mysten/sui/bcs", "bcs");
        let from_hex = &kotlin::import("@mysten/sui/utils", "fromHEX");
        let to_hex = &kotlin::import("@mysten/sui/utils", "toHEX");
        match ty {
    ...
    fn gen_reified(&mut self, ty: &Type, type_param_names: &[Tokens<Kotlin>]) -> kotlin::Tokens {
    ...
    pub fn gen_is_type_func(&self, tokens: &mut kotlin::Tokens) {
    ...
    fn gen_params_toks(
        &self,
        param_names: Vec<impl FormatInto<Kotlin>>,
    ...
    pub fn gen_fields_if(&mut self, tokens: &mut kotlin::Tokens) {
    ...
    fn interpolate(&self, str: String) -> kotlin::Tokens {
        let mut toks = kotlin::Tokens::new();
        toks.append(Item::OpenQuote(true));
    ...
    pub fn gen_struct_class(&mut self, tokens: &mut kotlin::Tokens) {
        ...
        let sui_parsed_data = &kotlin::import("@mysten/sui/client", "SuiParsedData");
        let sui_object_data = &kotlin::import("@mysten/sui/client", "SuiObjectData");
        let sui_client = &kotlin::import("@mysten/sui/client", "SuiClient");
        let bcs = &kotlin::import("@mysten/sui/bcs", "bcs");
        let bcs_type = &kotlin::import("@mysten/sui/bcs", "BcsType");
        let from_b64 = &kotlin::import("@mysten/sui/utils", "fromB64");
        let compress_sui_type = &self.framework.import("util", "compressSuiType");
        ...
        let type_args_field_type: &kotlin::Tokens = &quote!([$(for (idx, param) in type_params.iter().enumerate() join (, ) =>
        ...
        let type_args_param_if_any: &kotlin::Tokens = &match type_params.len() {
            0 => quote!(),
            1 => quote!(
